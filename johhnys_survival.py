...
try:
    ...
    gameover = pygame.image.load("./img/gameover1.jpeg")

        # 3.2 - 효과음 삽입
    takeoffsound = pygame.mixer.Sound("./lol_noti_voice/get_crazy.wav")
    landingsound = pygame.mixer.Sound("./lol_noti_voice/welcome1.wav")
    takeoffsound.play()
